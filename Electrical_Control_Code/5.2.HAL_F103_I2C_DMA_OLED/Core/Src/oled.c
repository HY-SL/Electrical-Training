...
char oledDisBuffer[8][128]   ;
char oledDidBufPageCount = 0 ;
...
#else
    if(y*128 + x + size > sizeof(oledDisBuffer))  return ;
...
{
    WS_OLED_Write_Cmd(0X8D);  //SET DCDC
...
void WS_OLED_Clear(void)
{
    ...
    for(i=0; i<8; i++)
    {
        WS_OLED_Write_Cmd (0xb0+i);
        WS_OLED_Write_Cmd (0x00);
        WS_OLED_Write_Cmd (0x10);
        for(n=0; n<128; n++)
        {
            WS_OLED_Write_Dat(0) ;
...
{
    0x00,0x00,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,0x00,0x40,0x42,0x44,0x58,0x40,0x7F,0x40,0x40,0x40,0x7F,0x40,0x50,0x48,0x46,0x40,0x00,
    0x40,0x40,0x42,0x42,0x42,0x42,0x42,0xC2,0x42,0x42,0x42,0x42,0x42,0x40,0x40,0x00,0x20,0x10,0x08,0x06,0x00,0x40,0x80,0x7F,0x00,0x00,0x00,0x02,0x04,0x08,0x30,0x00,
...
void WS_OLED_Init(void)
{
    ...
    WS_OLED_Write_Cmd(0xAE);//--display off
    WS_OLED_Write_Cmd(0x02);//---set low column address
...
//	WS_OLED_Printf(0,0,0,"OLED DIS TEST");
//	WS_OLED_Printf(0,2,1,"OLED DIS TEST");
//	WS_OLED_Printf(0,4,2,"OLED") ;
//	WS_OLED_Printf(64,4,3,"OLED");

//    WS_OLED_Dis_Date(0,0,1,(char *)oledDisplayTestCode16X16,4);
//    WS_OLED_Dis_Date(64,0,2,(char *)oledDisplayTestCode24X24,4);
//    WS_OLED_Dis_Date(64,4,3,(char *)oledDisplayTestCode32X32,2);
...
void WS_OLED_Start_Buffer_Update(void)
{
    ...
    buf[1] =  0x00;
    buf[2] =	0x10;
    WS_OLED_Write_Buffer(0x00,buf,3);

//  WS_OLED_Write_Cmd (0xb0 + oledDidBufPageCount);
//	WS_OLED_Write_Cmd (0x00);
//	WS_OLED_Write_Cmd (0x10);
    WS_OLED_Write_Buffer_DMA(0x40,(uint8_t *)oledDisBuffer[oledDidBufPageCount],128);
#endif
...
void HAL_I2C_MemTxCpltCallback(I2C_HandleTypeDef *hi2c)
{
     ...
     */
    //WS_Borad_Open_Buzzer_Time(1000);
